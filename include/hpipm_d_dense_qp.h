...
//
void d_cvt_colmaj_to_dense_qp(double *H, double *A, double *C, double *g, double *b, double *d_lb, double *d_ub, double *d_lg, double *d_ug, int *idxb, struct d_dense_qp *qp);
//
