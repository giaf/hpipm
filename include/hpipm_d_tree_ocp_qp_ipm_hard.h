...
struct d_ipm_hard_tree_ocp_qp_workspace
	{
...
struct d_ipm_hard_tree_ocp_qp_arg
	{
...
//
int d_memsize_ipm_hard_tree_ocp_qp(struct d_tree_ocp_qp *qp, struct d_ipm_hard_tree_ocp_qp_arg *arg);
//
void d_create_ipm_hard_tree_ocp_qp(struct d_tree_ocp_qp *qp, struct d_ipm_hard_tree_ocp_qp_arg *arg, struct d_ipm_hard_tree_ocp_qp_workspace *ws, void *mem);
//
void d_solve_ipm_hard_tree_ocp_qp(struct d_tree_ocp_qp *qp, struct d_tree_ocp_qp_sol *qp_sol, struct d_ipm_hard_tree_ocp_qp_workspace *ws);
//
void d_solve_ipm2_hard_tree_ocp_qp(struct d_tree_ocp_qp *qp, struct d_tree_ocp_qp_sol *qp_sol, struct d_ipm_hard_tree_ocp_qp_workspace *ws);
