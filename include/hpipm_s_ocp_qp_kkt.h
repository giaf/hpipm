...
//
void s_fact_solve_kkt_step_ocp_qp(struct s_ocp_qp *qp, struct s_ocp_qp_ipm_arg *arg, struct s_ocp_qp_ipm_workspace *ws);
//
void s_fact_solve_lq_kkt_step_ocp_qp(struct s_ocp_qp *qp, struct s_ocp_qp_ipm_arg *arg, struct s_ocp_qp_ipm_workspace *ws);
//
